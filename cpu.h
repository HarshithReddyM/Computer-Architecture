...
typedef struct CPU_Stage
{
  ...
  int cycles_in_execute;   //indicate number of cycles spent in execute stage
  int arithmetic_instr; // flag indicates if instruction setrs zero flag or not
  bool display_simulate;
  int dflag; 
} CPU_Stage;
